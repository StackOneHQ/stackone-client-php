...
class AtsCreateBackgroundCheckPackagesRequestDto
{
     ...
     * Package tests
     *
     * @var ?array<CreateAssessmentsPackages> $tests
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('tests')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\StackOne\client\Models\Components\CreateAssessmentsPackages>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?array<CreateAssessmentsPackages>  $tests
