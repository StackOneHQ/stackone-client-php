...
class AssessmentsRequestsJobHiringTeamApiModel
{
    /**
     ...
     * @param  ?string  $role
     */
    public function __construct(?string $userId = null, ?string $firstName = null, ?string $lastName = null, ?string $email = null, ?string $role = null)
    {
        $this->userId = $userId;
