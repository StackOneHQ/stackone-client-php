...
class ConnectSessionTokenAuthLink
{
     ...
     * @phpstan-pure
     */
    public function __construct(float $id, string $organizationId, string $projectId, string $originOwnerId, string $originOwnerName, \DateTime $createdAt, string $token, string $authLinkUrl, ?array $categories = null, ?string $provider = null, ?string $originUsername = null, ?string $accountId = null, ?string $label = null, ?ConnectSessionTokenAuthLinkMetadata $metadata = null, ?string $externalTriggerToken = null, ?ConnectSessionTokenAuthLinkType $type = null, ?string $integrationId = null)
    {
        $this->id = $id;
