...
class AtsGetAssessmentsRequestResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\AssessmentsOrderResult $assessmentsOrderResult = null, ?array $headers = [])
    {
