...
class AtsGetAssessmentsResultResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\AssessmentsResultsResult $assessmentsResultsResult = null, ?array $headers = [])
    {
