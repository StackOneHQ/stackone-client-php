...
class MarketingUpdateInAppTemplateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, Components\MarketingCreateInAppTemplateRequestDto $marketingCreateInAppTemplateRequestDto, ?string $prefer = null)
    {
