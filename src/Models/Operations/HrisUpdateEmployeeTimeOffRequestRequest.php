...
class HrisUpdateEmployeeTimeOffRequestRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, string $subResourceId, Components\HrisCreateTimeOffRequestDto $hrisCreateTimeOffRequestDto, ?string $prefer = null)
    {
