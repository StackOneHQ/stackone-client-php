...
class HrisListEmployeeDocumentsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?string $prefer = null, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListEmployeeDocumentsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
