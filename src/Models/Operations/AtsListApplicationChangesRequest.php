...
class AtsListApplicationChangesRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?string $prefer = null, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?string $pageSize = null, ?string $next = null, ?AtsListApplicationChangesQueryParamFilter $filter = null)
    {
