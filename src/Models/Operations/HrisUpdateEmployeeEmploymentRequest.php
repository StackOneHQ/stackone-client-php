...
class HrisUpdateEmployeeEmploymentRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, string $subResourceId, Components\HrisUpdateEmploymentRequestDto $hrisUpdateEmploymentRequestDto, ?string $prefer = null)
    {
