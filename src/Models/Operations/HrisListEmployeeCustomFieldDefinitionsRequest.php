...
class HrisListEmployeeCustomFieldDefinitionsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?string $prefer = null, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListEmployeeCustomFieldDefinitionsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
