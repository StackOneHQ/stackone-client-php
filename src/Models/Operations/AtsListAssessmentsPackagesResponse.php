...
class AtsListAssessmentsPackagesResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\AssessmentsPackagesPaginated $assessmentsPackagesPaginated = null, ?array $headers = [])
    {
