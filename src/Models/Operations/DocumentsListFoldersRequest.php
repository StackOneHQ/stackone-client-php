...
class DocumentsListFoldersRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?string $prefer = null, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?DocumentsListFoldersQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $folderId = null, ?string $include = null, ?string $nestedItems = 'false')
    {
