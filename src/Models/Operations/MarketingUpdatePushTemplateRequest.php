...
class MarketingUpdatePushTemplateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, Components\MarketingCreatePushTemplateRequestDto $marketingCreatePushTemplateRequestDto, ?string $prefer = null)
    {
