...
class HrisUpdateEmployeeWorkEligibilityRequestRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $subResourceId, string $xAccountId, Components\HrisCreateWorkEligibilityRequestDto $hrisCreateWorkEligibilityRequestDto, ?string $prefer = null)
    {
        $this->id = $id;
