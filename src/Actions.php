...
class Actions
{
     ...
     *
     * @param  Components\ActionBuildDto  $request
     * @return Operations\StackoneBuildActionEmbeddingsResponse
     * @throws \StackOne\client\Models\Errors\SDKException
     */
    public function buildActionEmbeddings(Components\ActionBuildDto $request, ?Options $options = null): Operations\StackoneBuildActionEmbeddingsResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/actions/build');
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'stackone_build_action_embeddings', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\StackOne\client\Models\Components\ActionBuildResponseDto', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\StackoneBuildActionEmbeddingsResponse(
                ...
                $response->next = function () use ($sdk, $responseData, $request): ?Operations\StackoneListActionsMetaResponse {
                    ...
                    return $sdk->listActionsMetaIndividual(
                        request: new Operations\StackoneListActionsMetaRequest(
                            ...
                            exclude: $request != null ? $request->exclude : null,
                        ),
                    );
                };
     ...
     *
     * @param  Components\ActionSearchDto  $request
     * @return Operations\StackoneSearchActionsResponse
     * @throws \StackOne\client\Models\Errors\SDKException
     */
    public function searchActions(Components\ActionSearchDto $request, ?Options $options = null): Operations\StackoneSearchActionsResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/actions/search');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'request', 'json');
        if ($body === null) {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'stackone_search_actions', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\StackOne\client\Models\Components\ActionSearchResponseDto', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\StackoneSearchActionsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
